...
public class Main {
    ...
    private static void quickSort(int[] arr, int from, int to) { // определяем массив, который нужно отсортировать (arr) и границы подмассива, в пределах которого будет сортировка (from, to)
        if (from < to){
    ...
    private static int partition(int[] arr, int from, int to) {
        int rightIndex = to; // конец
        int leftIndex = from; // начало
